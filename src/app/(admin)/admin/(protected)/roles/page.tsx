    ...
    <div>
      ...
      {roles.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-xl border border-gray-200">
          ...
          <h3 className="text-base font-semibold text-gray-900 mb-1">No roles yet</h3>
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <Link
                  ...
                  className="shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-colors"
                >
                  Edit
                </Link>
              </div>
