...
import { ChevronRight, Star, Minus, Plus, ShoppingCart, Truck, RotateCcw, Shield } from "lucide-react";
            ...
            <div className="border-t border-gray-100 pt-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div
                  ...
                  style={{ borderRadius: "var(--border-radius)" }}
                >
                  <button className="px-4 py-3 text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                    <Minus size={16} />
                  </button>
