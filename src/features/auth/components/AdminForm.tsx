  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
      ...
      <div className="bg-admin-surface rounded-xl border border-admin-border-md p-6 space-y-4">
        <h2 className="text-sm font-semibold text-admin-text-primary">Account Details</h2>
        <div>
      ...
      <div className="bg-admin-surface rounded-xl border border-admin-border-md p-6 space-y-3">
        <div>
          <h2 className="text-sm font-semibold text-admin-text-primary">Role</h2>
        ...
        {selectedRole && (
          <div className="mt-3">
            {selectedRole.isSuperAdmin ? (
              ...
              <div>
                <p className="text-xs font-medium text-admin-text-muted mb-2">
          ...
          <div className="space-y-2">
            {stores.map((store) => (
              ...
              >
                ...
                />
                <span className="text-sm text-admin-text-secondary">{store.name}</span>
              </label>
            ))}
          </div>
        </div>
