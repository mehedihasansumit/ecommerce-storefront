  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="text-sm border border-border-subtle bg-bg py-1.5 pl-2 pr-7 focus:outline-none focus:ring-2 focus:border-transparent appearance-none cursor-pointer text-text-secondary"
        style={{
