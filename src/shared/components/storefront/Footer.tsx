  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            ...
            <ul className="space-y-3 text-sm">
              {tenant?.contact?.address && (
                <li className="flex items-start gap-2.5">
                  ...
                  <span className="opacity-60">{tenant.contact.address}</span>
                </li>
              )}
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm opacity-50">
          <p>
          ...
          <div className="flex items-center gap-4">
            <span className="text-xs">
              {t("paymentMethods") || "We accept all major payment methods"}
            </span>
          </div>
        </div>
      </div>
